...
# new layers are trainable
n_ftrs = model.fc.in_features
model.fc1 = nn.Linear(n_ftrs, 50)
model.fc2 = nn.Linear(50, n_class)

model.localization = nn.Sequential(
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.base_model.fc1 = nn.Linear(n_ftrs, 50)
        self.base_model.fc2 = nn.Linear(50, n_class)
